    ...
    public class ScaleRate
    {
        ...
        public void ZoomImage(Image mainImage, AdvancedScrollViewer scrollViewer, MouseWheelEventArgs e)
        {
            ...
            else
            {
                ...
                var newWidth = ((FrameworkElement)Item.MainWindow.Content).ActualWidth * this.Scale;
                var newHeight = ((FrameworkElement)Item.MainWindow.Content).ActualHeight * this.Scale;
